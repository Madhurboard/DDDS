...
dlib_facelandmark = dlib.shape_predictor(
    "C:\\Users\\madhu\\"
    "OneDrive - MIT Art, Design & Technology University, Pune\\"
    "MINI PROJECT-SEM4\\shape_predictor_68_face_landmarks.dat"
)
...
while True:
    ...
    for face in faces:
        ...
        threshold = min(max_threshold, max(min_threshold, Eye_Rat))
